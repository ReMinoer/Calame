...
namespace Calame.Icons
{
    ...
    public class ComponentIconProvider : IDefaultIconDescriptorModule<IGlyphComponent>
    {
        ...
        public IconDescription GetIcon(IGlyphComponent glyphComponent)
        {
            ...
            {
                case ISceneNode _:
                    return new IconDescription(PackIconMaterialKind.GoogleCirclesExtended, SceneGraphCategoryBrush);
                case ICamera _:
                ...
                case FillingRectangle _:
                    return new IconDescription(PackIconMaterialKind.Fullscreen, GraphicsCategoryBrush);
                case RendererBase _:
                ...
                case IGridCollider _:
                    return new IconDescription(PackIconMaterialKind.Grid, PhysicsCategoryBrush);
                case ICollider _:
                ...
                case Controls _:
                    return new IconDescription(PackIconMaterialKind.GamepadVariant, InputCategoryBrush);
                    
                case Actor _:
                    return new IconDescription(PackIconMaterialKind.AccountBox, ScriptingCategoryBrush);
                case Trigger _:
                    return new IconDescription(PackIconMaterialKind.AlertOctagram, ScriptingCategoryBrush);
                    
                case Flipper _:
                    return new IconDescription(PackIconMaterialKind.Sync, CoreCategoryBrush);
                case ILayerRoot _:
                ...
                case SceneNodeEditor _:
                    return new IconDescription(PackIconMaterialKind.ArrowAll, ToolCategoryBrush);
